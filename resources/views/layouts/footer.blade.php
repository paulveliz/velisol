            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-col">
                        ...
                        <p>Nosotros somos velisol, una empresa comprometida en innovar las pequeñas y medianas empresas en México, construyendo software a la medida de la empresa solicitante para que esta pueda crecer en el ámbito digital a costos accesibles.</p>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Conoce nuestro <a class="turquoise" href="/nosotros">equipo de trabajo</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
